...
// if (discriminant > 0) {
//     alert(' Koklerin biri ' + root1 + ' Digeri ise ' + root2)
...
for (let index = 0; index < students.length; index++) {
    if (students[index].grade > 90) {
        console.log('Excellent student grade ' + students[index].name + ' ' + students[index].surname  + ' ' + students[index].grade);
    }
}

for (let index = 0; index < students.length; index++) {
    if (students[index].grade < 90 && students[index].grade >= 65) {
        console.log('Good student grade ' + students[index].name + ' ' + students[index].surname  + ' ' + students[index].grade);
    }
}

for (let index = 0; index < students.length; index++) {
    if (students[index].grade < 65 && students[index].grade >= 0) {
        console.log('Weak student grade ' + students[index].name + ' ' + students[index].surname  + ' ' + students[index].grade);
    }
}


for (let index = 0; index < students.length; index++) {
    if (students[index].age >18 && students[index].grade > 65) {
        if (students[index].age <18 && students[index].grade > 65) {
            
        } else {
            console.log(' Yas 18+ ' + students[index].name + ' ' + students[index].surname  + ' ' + students[index].grade + '  bali ' + students[index].age + ' yasi ');
        }
    } else {
        console.log(' Yas 18-' + students[index].name + ' ' + students[index].surname  + ' ' + students[index].grade +  ' bali ' + students[index].age + ' yasi ');
    }
...
for (let i = 0; i < students.length; i++) {
     if(students[i].surname == 'Mammadli'){
